/*
 * 2017/5/31  Kyuho Kim
 * Template for sending data to my own server
 */

const char* host = "my server address";
String url = "/logone?";   
...
const char* ssid = "myssid";   // Your own ssid here
const char* password = "mypassword";  // Your own password here
...
String working() { 
  ...
  return("seq="+ String(seq++) +"&device=100&unit=0&type=D&"+  String("pm25=")+String(pm25) +"&pm10="+ String(pm10));
}
